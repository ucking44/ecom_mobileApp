    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active"><i class="fa fa-edit"></i> Update Category</li>
        </ol>
            ...
            <form class="form-horizontal" action="{{ url('/update-category', $category_info->category_id) }}" method="POST">
                ...
                <fieldset>
                    ...
                    <div class="control-group hidden-phone">
                        ...
                        <div class="controls">
                            <textarea class="cleditor" name="category_description" rows="3" cols="25">{{ $category_info->category_description }}</textarea>
                        </div>
                    </div>

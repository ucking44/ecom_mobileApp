...
<head>
    ...
    <![endif]-->
	{{-- <link href="#" {{'Html' => Collective\Html\HtmlFacade::class }} rel="stylesheet"> --}}
	...
	{{--  THIS IS THE LINK FOR FONT AWESOME --}}
	{{-- <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.15.3/css/all.css" integrity="sha384-SZXxX4whJ79/gErwcOYf+zWLeJdY/qpuqC4cAa9rOGUstPomtqpuNWT9wdPEn2fk" crossorigin="anonymous"> --}}
	{{-- <script src="https://kit.fontawesome.com/c7036c7b9e.js" crossorigin="anonymous"></script> --}}
</head><!--/head-->
		...
		<div class="header-bottom"><!--header-bottom-->
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-3">
                        <form class="navbar-form" action="{{ URL::to('/search')}}" >
                            <div class="search_box pull-right">
                                <input type="text" name="query" class="search-box" value="" placeholder="SEARCH....."/>
                                <button type="submit" class="btn btn-black btn-round btn-just-icon" style="color: orange">
                                Search
